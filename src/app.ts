        ...
        if (state.activeClipId) {
            ...
            if (clip) {
                ...
                if (key === 'topText') {
                    ...
                    // Synchronize clip title in the left list with the edited top caption in real-time
                    ...
                    <div class="clip-card-main">
                        <div style="flex:1;">
                            ...
                            <div class="clip-actions">
                                ...
                                <button class="btn btn-danger btn-sm" onclick="deleteClip(${c.id}, event)" title="លុប Clip នេះ">🗑️ លុប</button>
                            </div>
                        </div>
                    </div>
                </div>
